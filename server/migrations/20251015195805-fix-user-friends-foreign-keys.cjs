...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.removeConstraint('user_friends', 'user_friends_user_id_fkey');
    await queryInterface.removeConstraint('user_friends', 'user_friends_friend_id_fkey');
